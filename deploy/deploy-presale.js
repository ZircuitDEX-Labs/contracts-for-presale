...
const networkConfigs = {
  ...
  'ethSepolia': {
    ...
    'operatorWallet': process.env.ETHSEPOLIA_PROTOCOL_WALLET || '',
  },
  'polygonAmoy': {
    ...
    'operatorWallet': process.env.POLYGONAMOY_PROTOCOL_WALLET || '',
  },
  'bscTestnet': {
    ...
    'operatorWallet': process.env.BSCTESTNET_PROTOCOL_WALLET || '',
  },
  ...
  'ethereum': {
    ...
    'protocolWallet': process.env.ETHEREUM_PROTOCOL_WALLET || '',
    'operatorWallet': process.env.ETHEREUM_OPERATOR_WALLET || '',
  },
  'bsc': {
    ...
    'protocolWallet': process.env.BSC_PROTOCOL_WALLET || '',
    'operatorWallet': process.env.BSC_OPERATOR_WALLET || '',
  },
  'polygon': {
    ...
    'protocolWallet': process.env.POLYGON_PROTOCOL_WALLET || '',
    'operatorWallet': process.env.POLYGON_OPERATOR_WALLET || '',
  },
};
